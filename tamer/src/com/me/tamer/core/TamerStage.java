...
public class TamerStage extends Stage{
	...
	private final float BEGIN_ZOOM_SPEED = 0.0001F;
	...
	public void controlCamera(){
		...
		case TAMER_CAMERA:
			...
			break;	
		case BEGIN_CAMERA:
			if (environment.getState() != RunningState.BEGIN_ZOOM) environment.setState(RunningState.BEGIN_ZOOM);
